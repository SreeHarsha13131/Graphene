...
//		 ezy.waitForUploadToCompleteJenkins();
		...
		String[] firstColumnData = xLUtils.getDataFromFirstColumn(excelDataSheet, "Config.Data");
...
//		Thread.sleep(1000);
		...
		String[] secondColumnData = xLUtils.getDataFromSecondColumn(excelDataSheet, "Config.Data");
