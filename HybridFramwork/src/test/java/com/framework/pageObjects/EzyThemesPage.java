...
//	NewExcelUtil newExcelUtil = new NewExcelUtil();
	...
	@FindBy(xpath = "//span[@class='MuiTouchRipple-root css-w0pj6f']/preceding:: button[@type='button']")
	@CacheLookup
	WebElement firstAddAreaOfInterestBtn;
...
//	}
	...
	public void firstAddAreaOfInterest() {
		if (firstAddAreaOfInterestBtn != null) {
			firstAddAreaOfInterestBtn.click();
		}
	}
